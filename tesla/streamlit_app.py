...
st.markdown("<h1 style='color: darkblue;'>TeslaBot</h1>", unsafe_allow_html=True)
st.markdown("<p style='color: darkblue;'>Find alle informationer om din Tesla Model Y fra brugerhåndbogen.</p>",
...
collection_load = chroma_client_load.get_collection(name="tesla", embedding_function=openai_ef)
###
